...
format0 DB "|------------------------|", 0Ah, 0
format1 DB "|                        |", 0Ah, 0
format2 DB "| Measure Multithreading |", 0Ah, 0
format3 DB "|                        |", 0Ah, 0
format4 DB "|------------------------|", 0Ah, 0
format5 DB "|              |   Min   |", 0Ah, 0
format6 DB "|------------------------|", 0Ah, 0
format7 DB "|              | %  7llu |", 0Ah, 0
...
main PROC PUBLIC
    ...
    mov retry, TRUE
    @Call CreateSimpleThread, DoWorkParallel, WORK_SIZE
...
@@:
    ...
    @Call printf, OFFSET format7, stack.measureMin
